...
import { registerUser, loginUser, registerEmployee, registerMultipleEmployees, verifyUser, verifyEmail, registerUserNo } from '../controllers/auth.controller.js';
...
router.get("/send-verification", verifyEmail);
